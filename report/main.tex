...
\appendix
\section*{Appendix: Key Configuration Files}
\addcontentsline{toc}{section}{Appendix: Key Configuration Files}

\subsection*{Jenkinsfile}
\lstinputlisting[language=Java]{../Jenkinsfile}

\subsection*{Dockerfile}
\lstinputlisting[language=bash]{../Dockerfile}

\subsection*{Docker Compose Definition}
\lstinputlisting[language=YAML]{../docker-compose.bluegreen.yml}

\subsection*{Deployment Script}
\lstinputlisting[language=bash]{../scripts/deploy-color.sh}

\subsection*{Traffic Switch Script}
\lstinputlisting[language=bash]{../scripts/switch-color.sh}
